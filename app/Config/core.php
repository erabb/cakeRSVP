 ...
 *
 */
Configure::write('Routing.prefixes', array('www.example.com/admin/controller'));
 ...
 */
	Configure::write('Security.salt', '$2a$07$robinhoodheadcomesoff$');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '85729575960242105866393057438206');
